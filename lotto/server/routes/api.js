...
var CheckRequest = require(LottoConstant.ABS + "lib/request/check_request");
...
async function manageUrlParams(req, res, next) {
  ...
  //console.log(req.params.param1,req.params.param2,req.params.param3,req.params.param4,req.params.param5);
  ...
  var file_src_str = LottoConstant.ABS + "routes/api/" + class_path_str + ".js";
  if (fs.existsSync(file_src_str)) {
    var TargetClass = require(LottoConstant.ABS + "routes/api/" + class_path_str);
