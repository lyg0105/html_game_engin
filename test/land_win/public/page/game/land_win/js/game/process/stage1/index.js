...
class Stage1Process {
  ...
  init() {
    ...
    this.game_data.event.on_mouse_down_custom = (e) => {
      ...
      if (main.game_data.control.control_json.chat_toggle) {
        if (main.game_data.chat.is_mounse_in_chat_area()) {
          return false;
        }
      }
    ...
    this.game_data.event.on_mouse_up_custom = (e) => {
      ...
      if (main.game_data.control.control_json.chat_toggle) {
        if (main.game_data.chat.is_mounse_in_chat_area()) {
          main.game_data.chat.on_mouse_up();
          return false;
        }
      }
    ...
    this.game_data.event.on_key_up_custom = (e) => {
      if(main.game_data.chat.is_focus_input){
        main.game_data.chat.on_key_up(e);
        return;
      }
